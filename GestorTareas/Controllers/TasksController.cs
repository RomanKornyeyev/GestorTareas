...
using TaskEntity = GestorTareas.Models.Entities.Task;
...
namespace GestorTareas.Controllers
{
    public class TasksController : Controller
    {
        ...
        {
            var appDbContext = _context.Task.Include(t => t.Priority).Include(t => t.Status).Include(t => t.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Subtitle,ImageUrl,Text,UserId,StatusId,PriorityId")] TaskEntity task)
        {
            ...
            ViewData["StatusId"] = new SelectList(_context.Set<Status>(), "Id", "Description", task.StatusId);
